...
export async function generateMetadata({
  ...
  const { alternativePage, moreAlternativePages } = await getAlternativePages(
    params.slug
  );
...
const getAlternativePages = cache(
  async (
    slug: string
  ): Promise<{
    alternativePage: AlternativesType;
    moreAlternativePages: AlternativesType[];
  }> => {
    const query = `
    {
      ...
      <div className="min-h-screen w-full flex flex-col justify-center">
        ...
        <Suspense>
          <AuroraHero
            title={alternativePage.title!}
            description={alternativePage.description!}
            image={alternativePage.heroImage}
          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-4 gap-4 md:px-24">
            <div>
              <Image
                ...
                src={urlFor(alternativePage.agImage1.asset?._ref)
                  .height(1000)
                  .width(1000)
                  .url()}
                sizes="100vw"
              ...
              {alternativePage.agLink1 ? (
                <Link
                  href={alternativePage.agLink1!}
                  target="_blank"
                  className="text-md text-foreground-500 text-center pt-2"
                >
            ...
            <div>
              <Image
                ...
                src={urlFor(alternativePage.agImage2.asset?._ref)
                  .height(1000)
                  .width(1000)
                  .url()}
                sizes="100vw"
            ...
            <div>
              <Image
                ...
                src={urlFor(alternativePage.agImage3.asset?._ref)
                  .height(1000)
                  .width(1000)
                  .url()}
                sizes="100vw"
            ...
            <div>
              <Image
                ...
                src={urlFor(alternativePage.agImage4.asset?._ref)
                  .height(1000)
                  .width(1000)
                  .url()}
                sizes="100vw"
            ...
            <BounceCard className="col-span-12 md:col-span-4">
              ...
              <div className="absolute bottom-0 left-4 right-4 top-32 translate-y-8 rounded-t-2xl bg-gradient-to-br from-violet-400 to-indigo-400 p-4 transition-transform duration-[250ms] group-hover:translate-y-4 group-hover:rotate-[2deg]">
                <Image
                  ...
                  src={urlFor(alternativePage.featureImage1.asset?._ref)
                    .height(1000)
                    .width(1000)
                    .url()}
                  sizes="100vw"
            ...
            <BounceCard className="col-span-12 md:col-span-8">
              ...
              <div className="absolute bottom-0 left-4 right-4 top-32 translate-y-8 rounded-t-2xl bg-gradient-to-br from-amber-400 to-orange-400 p-4 transition-transform duration-[250ms] group-hover:translate-y-4 group-hover:rotate-[2deg]">
                <Image
                  ...
                  src={urlFor(alternativePage.featureImage2.asset?._ref)
                    .height(1000)
                    .width(1000)
                    .url()}
                  sizes="100vw"
            ...
            <BounceCard className="col-span-12 md:col-span-8">
              ...
              <div className="absolute bottom-0 left-4 right-4 top-32 translate-y-8 rounded-t-2xl bg-gradient-to-br from-green-400 to-emerald-400 p-4 transition-transform duration-[250ms] group-hover:translate-y-4 group-hover:rotate-[2deg]">
                <Image
                  ...
                  src={urlFor(alternativePage.featureImage3.asset?._ref)
                    .height(1000)
                    .width(1000)
                    .url()}
                  sizes="100vw"
            ...
            <BounceCard className="col-span-12 md:col-span-4">
              ...
              <div className="absolute bottom-0 left-4 right-4 top-32 translate-y-8 rounded-t-2xl bg-gradient-to-br from-pink-400 to-red-400 p-4 transition-transform duration-[250ms] group-hover:translate-y-4 group-hover:rotate-[2deg]">
                <Image
                  ...
                  src={urlFor(alternativePage.featureImage4.asset?._ref)
                    .height(1000)
                    .width(1000)
                    .url()}
                  sizes="100vw"
        ...
        <section className="px-12 md:px-24 md:pt-12 pb-24">
          ...
          <div className="grid grid-cols-5 bg-slate-900 rounded-xl">
            <Image
              ...
              src={urlFor(alternativePage.logoImage1.asset?._ref)
                .height(1000)
                .width(1000)
                .url()}
              sizes="100vw"
            ...
            <Image
              ...
              src={urlFor(alternativePage.logoImage2.asset?._ref)
                .height(1000)
                .width(1000)
                .url()}
              sizes="100vw"
            ...
            <Image
              ...
              src={urlFor(alternativePage.logoImage3.asset?._ref)
                .height(1000)
                .width(1000)
                .url()}
              sizes="100vw"
            ...
            <Image
              ...
              src={urlFor(alternativePage.logoImage4.asset?._ref)
                .height(1000)
                .width(1000)
                .url()}
              sizes="100vw"
            ...
            <Image
              ...
              src={urlFor(alternativePage.logoImage5.asset?._ref)
                .height(1000)
                .width(1000)
                .url()}
              sizes="100vw"
              ...
              <Card className="p-4 bg-slate-200 dark:bg-slate-900">
                <CardHeader className="w-full flex items-center justify-center">
                  <Image
                    ...
                    src={urlFor(alternativePage.personImage1.asset?._ref)
                      .height(1000)
                      .width(1000)
                      .url()}
                    sizes="100vw"
              ...
              <Card className="pt-8 bg-slate-200 dark:bg-slate-900">
                <CardHeader className="w-full flex items-center justify-center">
                  <Image
                    ...
                    src={urlFor(alternativePage.personImage2.asset?._ref)
                      .height(1000)
                      .width(1000)
                      .url()}
                    sizes="100vw"
              ...
              <Card className="pt-8 bg-slate-200 dark:bg-slate-900">
                <CardHeader className="w-full flex items-center justify-center">
                  <Image
                    ...
                    src={urlFor(alternativePage.personImage3.asset?._ref)
                      .height(1000)
                      .width(1000)
                      .url()}
                    sizes="100vw"
        ...
        <section className="px-12 md:px-24 md:pt-12 pb-24">
          {moreAlternativePages?.length > 0 && (
            <MoreAlts alts={moreAlternativePages} />
          )}
        </section>
      </div>
    </>
