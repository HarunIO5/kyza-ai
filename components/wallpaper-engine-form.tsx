...
export default function WallpaperEngineForm() {
  ...
  const onSubmit = async (
    ...
    const response = await fetch("/api/stableDiffuse", {
      ...
      body: JSON.stringify({
        prompt: `Create a wallpaper design with focus on atmospheric backgrounds, smooth motion with subtle effects, high-resolution for desktop wallpapers, dynamic lighting and particle effects. Based on the following prompt: ${values.prompt}`,
  ...
  useEffect(() => {
    async function firstGeneration({ prompt }: { prompt: string }) {
      ...
      const response = await fetch("/api/stableDiffuse", {
        ...
        body: JSON.stringify({
          prompt: `Create a wallpaper design with focus on atmospheric backgrounds, smooth motion with subtle effects, high-resolution for desktop wallpapers, dynamic lighting and particle effects. Based on the following prompt: ${prompt}`,
          // scale: scale,
          // spees: speed,
          aspect_ratio: ratio,
          // email: session?.user?.email!,
              ...
              >
                <div className="w-full mb-4">
                  <Textarea
                    ...
                    disabled={isLoading}
                    placeholder="A single cherry blossom petal slowly falling through sunlit air in an ancient Japanese garden. The camera follows its gentle descent in slow motion, capturing the translucent texture of the petal as sunbeams pass through it."
                    className="pb-4"
                    {...register("prompt", {
                      onChange: (e) => {
                ...
                <div className="embla__container w-full">
                  <div className="embla__slide flex items-center justify-center">
                    <Image
                      ...
                      width={1000}
                      height={1000}
                      src="https://xlbwajpxfttzluwdymao.supabase.co/storage/v1/object/public/tools/wallpaper-engine/wallpaper-features-3.jpg"
                      alt="wallpaper features 3"
                  ...
                  <div className="embla__slide flex items-center justify-center">
                    <Image
                      ...
                      width={1000}
                      height={1000}
                      src="https://xlbwajpxfttzluwdymao.supabase.co/storage/v1/object/public/tools/wallpaper-engine/wallpaper-features-4.jpg"
                      alt="wallpaper features 4"
                      className="h-full w-full object-cover blur-sm opacity-30"
                    />
                  </div>
                  <div className="embla__slide flex items-center justify-center">
                    <Image
                      ...
                      width={1000}
                      height={1000}
                      src="https://xlbwajpxfttzluwdymao.supabase.co/storage/v1/object/public/tools/wallpaper-engine/wallpaper-features-5.jpg"
                      alt="wallpaper features 5"
                      className="h-full w-full object-cover blur-sm opacity-30"
                    />
                  </div>
                </div>
