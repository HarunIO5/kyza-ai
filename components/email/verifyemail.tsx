import {
  ...
  export const VerifyEmail = ({
    ...
    return (
      <Html>
        <Head />
        <Preview>Hi, Thanks for starting a new KYZA account. We want to make sure it&apos;s really you. 
              If this was you, you can verify your account here:</Preview>
        <Body style={main}>
          ...
          />
            <Section>
              ...
              <Text style={text}>
              Thanks for starting a new CloudSecurityExams account. We want to make sure it&apos;s really you. 
              ...
              <Text style={text}>
                If you don&apos;t want to create an account or didn&apos;t
