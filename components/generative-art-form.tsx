...
export default function GenerativeArtForm() {
  ...
  const onSubmit = async (
    ...
    const response = await fetch("/api/stableDiffuse", {
      ...
      body: JSON.stringify({
        prompt: `Create abstract and imaginative art, blend surreal and dream-like styles, use bold colors and expressive shapes, focus on artistic textures and creativity, incorporate mixed media feel. Based of the following prompt: ${values.prompt}`,
  ...
  useEffect(() => {
    async function firstGeneration({ prompt }: { prompt: string }) {
      ...
      const response = await fetch("/api/stableDiffuse", {
        ...
        body: JSON.stringify({
          prompt: `Create abstract and imaginative art, blend surreal and dream-like styles, use bold colors and expressive shapes, focus on artistic textures and creativity, incorporate mixed media feel. Based of the following prompt: ${prompt}`,
          // scale: scale,
          // spees: speed,
          aspect_ratio: ratio,
          // email: session?.user?.email!,
            ...
            <div className="flex-grow w-full">
              ...
              >
                <div className="w-full mb-4">
                  <Textarea
                    type="text"
                    label="Describe your generative art"
                    value={prompt}
                    disabled={isLoading}
                    labelPlacement="outside"
                    placeholder="Flowing fractal patterns in blues and teals that evolve from geometric shapes in the center to organic tendrils at the edges. Add floating light particles throughout and transition to warm gold accents in the outer regions. Create a mathematical yet dreamlike atmosphere."
                    className="pb-4"
                    {...register("prompt", {
                      onChange: (e) => {
                ...
                <div className="embla__container w-full">
                  <div className="embla__slide flex items-center justify-center">
                    <Image
                      ...
                      width={700}
                      height={1000}
                      src="https://xlbwajpxfttzluwdymao.supabase.co/storage/v1/object/public/tools/gen-art/Logotipo%20enmarcado%20en%20un%20hexagono%203d%20estilo%20azteca.webp"
                      alt="Logotipo enmarcado en un hexagono 3d estilo azteca"
                  ...
                  <div className="embla__slide flex items-center justify-center">
                    <Image
                      ...
                      width={700}
                      height={1000}
                      src="https://xlbwajpxfttzluwdymao.supabase.co/storage/v1/object/public/tools/gen-art/Taoist%20tesseract%20body%20fractal%20three%20point%20perspect.webp"
                      alt="Taoist tesseract body fractal three point perspect"
                      className="h-full w-full object-cover blur-sm opacity-30"
                    />
                  </div>
                  <div className="embla__slide flex items-center justify-center">
                    <Image
                      ...
                      width={500}
                      height={1000}
                      src="https://xlbwajpxfttzluwdymao.supabase.co/storage/v1/object/public/tools/gen-art/isometric%20shape.webp"
                      alt="Isometric shape"
                      className="h-full w-full object-cover blur-sm opacity-30"
                    />
                  </div>
