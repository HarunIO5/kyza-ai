...
export default function AnimeImagesForm() {
  ...
  const onSubmit = async (
    ...
    const response = await fetch("/api/stableDiffuse", {
      ...
      body: JSON.stringify({
        prompt: `Generate detailed anime-style characters, focus on dynamic anime poses, sharp line art and vivid colors, express strong emotions through style, traditional manga shading techniques. Based of the following prompt: ${values.prompt}`,
  ...
  useEffect(() => {
    async function firstGeneration({ prompt }: { prompt: string }) {
      ...
      const response = await fetch("/api/stableDiffuse", {
        ...
        body: JSON.stringify({
          prompt: `Generate detailed anime-style characters, focus on dynamic anime poses, sharp line art and vivid colors, express strong emotions through style, traditional manga shading techniques. Based of the following prompt: ${prompt}`,
          // scale: scale,
          // spees: speed,
          aspect_ratio: ratio,
          // email: session?.user?.email!,
            ...
            <div className="flex-grow w-full">
              ...
              >
                <div className="w-full mb-4">
                  <Textarea
                    type="text"
                    label="Describe your anime & manga art"
                    value={prompt}
                    disabled={isLoading}
                    labelPlacement="outside"
                    placeholder="Determined young samurai with flowing red hair and battle-worn armor standing on a cliff at sunset, cherry blossoms swirling in the wind, dynamic action pose, dramatic lighting, detailed background, shounen style."
                    className="pb-4"
                    {...register("prompt", {
                      onChange: (e) => {
                ...
                <div className="embla__container w-full">
                  <div className="embla__slide flex items-center justify-center">
                    <Image
                      ...
                      width={500}
                      height={800}
                      src="https://xlbwajpxfttzluwdymao.supabase.co/storage/v1/object/public/tools/anime-art/A%20black%20and%20white%20picture%20for%20coloring%20of%20an%20anime.webp"
                      alt="A black and white picture for coloring of an anime"
                  ...
                  <div className="embla__slide flex items-center justify-center">
                    <Image
                      ...
                      width={500}
                      height={800}
                      src="https://xlbwajpxfttzluwdymao.supabase.co/storage/v1/object/public/tools/anime-art/a%20group%20of%207%20young%20adults.webp"
                      alt="A group of 7 young adults"
                      className="h-full w-full object-cover blur-sm opacity-30"
                    />
                  </div>
                  <div className="embla__slide flex items-center justify-center">
                    <Image
                      ...
                      width={500}
                      height={800}
                      src="https://xlbwajpxfttzluwdymao.supabase.co/storage/v1/object/public/tools/anime-art/anime%20face%20portrait%20boy%20with%20grey%20eyes.webp"
                      alt="Anime face portrait boy with grey eyes"
                      className="h-full w-full object-cover blur-sm opacity-30"
                    />
                  </div>
                </div>
