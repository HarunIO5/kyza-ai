...
export default function LandingPageHeading () {
    return (
        <>
			...
			<div className="px-4 inline-block max-w-xl text-center justify-center z-10">
				<h1 className={title()}>Search For&nbsp;</h1>
				<h1 className={`${title()} inline-flex animate-text-gradient bg-gradient-to-r from-[#57cdf8] via-[#f9a8fd] to-[#ac4cf5] bg-[200%_auto] bg-clip-text italic text-transparent`}>Beautiful&nbsp;</h1>
				<br />
				<h1 className={title()}>
					AI Videos
				</h1>
