              ...
              >
                <div className="w-full mb-4">
                  <Textarea
                    ...
                    disabled={isLoading}
                    placeholder="Camera slowly panning through abandoned underwater research lab with flickering lights, bubbles rising from broken equipment, and a mysterious shadow moving behind fogged glass windows. Cool blue color grading with red alarm lights."
                    className="pb-4"
                    {...register("prompt", {
                      onChange: (e) => {
