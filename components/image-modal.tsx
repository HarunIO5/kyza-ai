                  ...
                  <CardBody>
                    ...
                    <div className="flex flex-row items-center gap-2 mt-4">
                      ...
                      <Button
                        ...
                        className="relative inline-flex w-fit items-center justify-center dark:bg-white font-medium text-gray-950 transition-colors focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-gray-50"
                      >
                        Remix
                      </Button>
                    </div>
